...
class NameFormatterTests: XCTestCase {
  ...
  func test_invertName_GivenAnHonorificAndFirstName_ShouldReturnHonorificAndFirstName() {
  ...
  func test_invertName_GivenAnHonorificFirstNameAndLastName_ShouldReturnHonorificLastNameAndFirstName() {
  ...
  func test_invertName_GivenAnHonorificFirstNameAndLastNameWithExtraSpaces_ShouldReturnHonorificLastNameAndFirstName() {
    let inputName = " Dr. first-name last-name "
    let expectedOutput = "Dr. last-name, first-name"
